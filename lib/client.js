  ...
  youjs.prototype = {
    ...
    core: {
      ...
      init: function(uri, youjs) {
        ...
        resolveFqns = function(rootObj, fqns) {
                ...
                if (typeof activePathObj[piece] === 'undefined') {
                  if (isLastPiece === true) {
                    activePathObj[piece] = function() {
                      ...
                      cbMap[id] = cb;
                      console.log('server please execute ', fqn, id, args);
                      socket.emit('execute', {fqn: fqn, id: id, args: args});
                    }.bind({fqn: fqn});
        ...
        socket.on('fqns', function(obj) {
          ...
          for (var groupName in obj) {
            ...
            resolveFqns(youjs, fqnMap[groupName]);
